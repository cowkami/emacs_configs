...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(line-number                              ((,class (:foreground ,line-num :background ,bg0))))
...
(provide-theme 'custom-tron-legacy)
(provide 'custom-tron-legacy-theme)
